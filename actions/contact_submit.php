...
if ($len < 5)              $errors[] = 'Wiadomość jest zbyt krótka.';
elseif ($len > 2000)       $errors[] = 'Wiadomość jest zbyt długa (max 2000 znaków).';
...
if (AppConfig::storageDriver() === 'db') {
  try {
    $ok = ContactRepo::insert($name, $email, $message, $ip, $ua);
  } catch (Throwable $e) {
